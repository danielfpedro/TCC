...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('dt_emprestimo'); ?></th>
			<th><?php echo $this->Paginator->sort('dt_entrega'); ?></th>
	...
	<tr>
		<td><?php echo h($livrosEmprestimo['LivrosEmprestimo']['id']); ?>&nbsp;</td>
		<td><?php echo h($livrosEmprestimo['LivrosEmprestimo']['livro_nome']); ?>&nbsp;</td>
		<td><?php echo h($livrosEmprestimo['LivrosEmprestimo']['dt_emprestimo']); ?>&nbsp;</td>
		<td><?php echo h($livrosEmprestimo['LivrosEmprestimo']['dt_entrega']); ?>&nbsp;</td>
		<td>
