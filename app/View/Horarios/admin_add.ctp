...
<?php
	...
	?>
	<fieldset>
		<legend><?php echo __('Adicionar  Horario'); ?></legend>
	<?php
		echo $this->Form->input('dia_semana', array('empty'=> 'Selecione:','class'=> 'form-control'));
		echo $this->Form->input('horario', array('empty'=> 'Selecione:','class'=> 'form-control'));
